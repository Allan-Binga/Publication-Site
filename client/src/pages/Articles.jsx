        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          {loading ? (
            ...
            articles.map((article) => (
              ...
              >
                <article
                  className="flex flex-col bg-white rounded-lg  overflow-hidden  border border-slate-200 transition-shadow"
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-100">
                      <span className="text-primary font-semibold text-sm inline-flex items-center text-xs hover:underline">
                        Read article
